...
expectedContains = ["<jar href=\"lib/share.jar\" version=\"1.0-SNAPSHOT\"/>", "<jar href=\"lib/client1-1.0-SNAPSHOT.jar\"/>", "<jar href=\"lib/share1.jar\" version=\"1.0-SNAPSHOT\"/>", "<jar href=\"lib/client-1.0-SNAPSHOT.jar\" main=\"true\"/>", "<jar href=\"lib/provided-1.0-SNAPSHOT.jar\"/>",]
expectedContains.each {
    assert assertContains(content, it)
}
...
expectedFiles = [ "client-1.0-SNAPSHOT.jar", "client1-1.0-SNAPSHOT.jar", "share-1.0-SNAPSHOT.jar","share1-1.0-SNAPSHOT.jar", "provided-1.0-SNAPSHOT.jar", "version.xml" ]
expectedFiles.each{
...
expectedContains = [ "<file>client-1.0-SNAPSHOT.jar</file>", "<file>share-1.0-SNAPSHOT.jar</file>", "<file>share1-1.0-SNAPSHOT.jar</file>", "<file>client1-1.0-SNAPSHOT.jar</file>", "<file>provided-1.0-SNAPSHOT.jar</file>" ]
expectedContains.each{
  assert assertContains( content,  it )
}
